...
# ----------------------------------------------------------------------
# Travel-agency specialty values (added 2026-08-04).
#
# travel_jobs carried 284 distinct non-canonical values across 26,514 active
# contracts - Medical-Surgical vs Med / Surg, ER vs Emergency / Trauma, and
# so on - so half the travel board was unreachable by the specialty filter
# and unusable for geo landing pages. These 131 aliases fold 77.6% of that
# onto the canonical 29.
#
# The remainder is DELIBERATELY left alone: General, Outpatient, Skilled,
# Acute, Adult, Long Term Acute Care, Rehabilitation, Clinic, Correctional,
# and the school-education roles are settings, populations or non-clinical
# jobs with no honest home in a clinical taxonomy. Guessing would be worse
# than leaving them.
#
# Keys are _norm_ats() form: lowercase, punctuation -> space, ws collapsed.
TRAVEL_ALIASES = {
    'admission': 'Med / Surg',
    'adult cardiothoracic': 'Cardiac / Cardiovascular',
    'adult echocardiography': 'Radiology / Imaging',
    'ambulatory or': 'Operating Room / Surgery',
    'ambulatory pre post op': 'Operating Room / Surgery',
    'biomed technician': 'Support Staff',
    'bone marrow transplant': 'Oncology',
    'bone marrow transplantation': 'Oncology',
    'breast': 'Radiology / Imaging',
    'bsn case manager': 'Social Work / Case Management',
    'burn': 'ICU / Critical Care',
    'cardiac icu': 'ICU / Critical Care',
    'cardiac sonography': 'Radiology / Imaging',
    'cardiovascular electrophysiology specialist': 'Cardiac / Cardiovascular',
    'cardiovascular interventional radiology': 'Radiology / Imaging',
    'cardiovascular invasive specialist': 'Cardiac / Cardiovascular',
    'cardiovascular or': 'Operating Room / Surgery',
    'case management': 'Social Work / Case Management',
    'case manager': 'Social Work / Case Management',
    'cath lab': 'Cardiac / Cardiovascular',
    'cds interim director': 'Healthcare Administration',
    'cds outpatient': 'Healthcare Administration',
    'cdu clinical decision unit': 'Med / Surg',
    'clinical fellowship school': 'Speech Language Pathology',
    'clinical liaison': 'Social Work / Case Management',
    'cma': 'Support Staff',
    'computed tomography': 'Radiology / Imaging',
    'critical care': 'ICU / Critical Care',
    'cvicu': 'ICU / Critical Care',
    'cvor': 'Operating Room / Surgery',
    'cvor first assist': 'Operating Room / Surgery',
    'cytotechnologist': 'Laboratory',
    'cytotechnology': 'Laboratory',
    'dental assistant': 'Support Staff',
    'diagnostic': 'Radiology / Imaging',
    'diagnostic medical sonography general': 'Radiology / Imaging',
    'dialysis': 'Wound Care / Dialysis',
    'dou direct observation unit': 'Med / Surg',
    'echo': 'Radiology / Imaging',
    'echo vascular technician': 'Radiology / Imaging',
    'eeg': 'Laboratory',
    'emergency room': 'Emergency / Trauma',
    'endoscopy': 'Operating Room / Surgery',
    'ep lab': 'Cardiac / Cardiovascular',
    'er': 'Emergency / Trauma',
    'first assist': 'Operating Room / Surgery',
    'first assistant': 'Operating Room / Surgery',
    'home health hospice': 'Home Health',
    'hospice': 'Home Health',
    'house supervisor': 'Healthcare Administration',
    'icu': 'ICU / Critical Care',
    'infusion therapy': 'Wound Care / Dialysis',
    'intermediate care': 'Med / Surg',
    'interventional radiology': 'Radiology / Imaging',
    'iv therapy': 'Wound Care / Dialysis',
    'lcsw': 'Social Work / Case Management',
    'long term care': 'Home Health',
    'magnetic resonance imaging': 'Radiology / Imaging',
    'mammogram': 'Radiology / Imaging',
    'mammography': 'Radiology / Imaging',
    'mammography tech': 'Radiology / Imaging',
    'medical icu micu': 'ICU / Critical Care',
    'medical lab scientist medical technologist': 'Laboratory',
    'medical lab tech': 'Laboratory',
    'medical surgical': 'Med / Surg',
    'medical surgical telemetry': 'Med / Surg',
    'mother baby': 'Labor & Delivery',
    'ms': 'Med / Surg',
    'msw': 'Social Work / Case Management',
    'multimodal technologist': 'Radiology / Imaging',
    'neonatal icu nicu': 'ICU / Critical Care',
    'nephrology': 'Wound Care / Dialysis',
    'neuro icu': 'ICU / Critical Care',
    'nicu': 'ICU / Critical Care',
    'nuclear med tech': 'Radiology / Imaging',
    'nuclear medicine': 'Radiology / Imaging',
    'nurse navigator': 'Social Work / Case Management',
    'nursery': 'Pediatrics',
    'ob gyn': 'Labor & Delivery',
    'obstetrics gynecology': 'Labor & Delivery',
    'operating room': 'Operating Room / Surgery',
    'operating room circulating': 'Operating Room / Surgery',
    'operating room first assist': 'Operating Room / Surgery',
    'ophthalmic technician': 'Support Staff',
    'or': 'Operating Room / Surgery',
    'orthopaedics': 'Med / Surg',
    'orthopedic surgery': 'Operating Room / Surgery',
    'orthopedics': 'Med / Surg',
    'ot rehab': 'Occupational Therapy',
    'outpatient oncology': 'Oncology',
    'pacu': 'Operating Room / Surgery',
    'pb profee coder': 'Healthcare Administration',
    'pcu': 'Med / Surg',
    'pedi': 'Pediatrics',
    'pedi or': 'Operating Room / Surgery',
    'pedi outpatient clinic': 'Pediatrics',
    'pedi pacu': 'Operating Room / Surgery',
    'pediatric icu picu': 'ICU / Critical Care',
    'picu': 'ICU / Critical Care',
    'polysomnographer': 'Laboratory',
    'polysomnography': 'Laboratory',
    'positron emission tomography': 'Radiology / Imaging',
    'post anesthesia care unit pacu': 'Operating Room / Surgery',
    'postpartum': 'Labor & Delivery',
    'pre op': 'Operating Room / Surgery',
    'pre post op': 'Operating Room / Surgery',
    'private duty': 'Home Health',
    'psych': 'Behavioral Health / Psych',
    'psychiatry': 'Behavioral Health / Psych',
    'psychologist': 'Behavioral Health / Psych',
    'pt ltac': 'Physical Therapy',
    'quality assurance': 'Healthcare Administration',
    'radiation': 'Radiology / Imaging',
    'radiation therapist': 'Radiology / Imaging',
    'radiography': 'Radiology / Imaging',
    'radiology': 'Radiology / Imaging',
    'rn case manager': 'Social Work / Case Management',
    'school psychologist': 'Behavioral Health / Psych',
    'school psychologist certified': 'Behavioral Health / Psych',
    'skilled nursing': 'Home Health',
    'sonography': 'Radiology / Imaging',
    'special procedures technologist': 'Radiology / Imaging',
    'step down': 'Med / Surg',
    'sterile processor': 'Surgical Tech',
    'surgical icu sicu': 'ICU / Critical Care',
    'telemetry': 'Med / Surg',
    'vascular': 'Radiology / Imaging',
    'vascular access': 'Wound Care / Dialysis',
    'vascular tech sonography': 'Radiology / Imaging',
    'wound care': 'Wound Care / Dialysis',
    'wound ostomy continence': 'Wound Care / Dialysis',
}

# Merge so canonical_specialty() picks these up. Module-level, and the
# functions resolve ATS_ALIASES at call time, so ordering is safe.
ATS_ALIASES.update(TRAVEL_ALIASES)
