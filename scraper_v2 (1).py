...
INFOR_ORGS = {
    ...
    "CHRISTUS Health": (
        ...
        "https://css-christushealth-prd.inforcloudsuite.com/hcm/Jobs/navigation/JobBoard(CH00%2CEXTERNAL).JobSearchCompositeFormNav?csk.HROrganization=CH00&csk.JobBoard=EXTERNAL"
    ),
}
